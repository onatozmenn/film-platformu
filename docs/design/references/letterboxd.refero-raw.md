...
> [!IMPORTANT]
> This archived file is a visual reference extract, not the implementation contract. Follow [docs/05-DESIGN-SYSTEM.md](../../05-DESIGN-SYSTEM.md) and root `DESIGN.md` instead. In particular: use DM Sans and Source Serif 4; set letter spacing to `0`; do not create font tokens for `object-fit` or `masonry`; and use Acid Green as the primary CTA and rating color.
...
- border: #2c3440
- primary action: #00e054 with near-black text

**Example Component Prompts**

Use Acid Green (#00e054) only for the primary CTA and rating stars, with near-black CTA text for accessible contrast.
