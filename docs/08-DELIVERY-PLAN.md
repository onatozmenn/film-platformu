...
- Remote validation: pending the WP-07 repository implementation commit and exact-SHA CI run. Protected release-readiness, migration, restore, and staging workflows cannot pass until their owner-managed GitHub Environments, values, and external systems exist.
